...
graph LR
  ...
  Badges_and_Tags --> Free_Trial_Card
  Button --> Product_Content
  Stepper_Control --> Product_Content
  Star --> Product_Content
  Badges_and_Tags --> Product_Content
  Price_and_Label --> Product_Content
  Text_Button_Icon_Right --> Product_Content
  Next_Previous_Selector --> Slider_page_selector
  Slider_Scroll_Bar --> Slider_page_selector
  Star --> Carousel_Product
  Badges_and_Tags --> Carousel_Product
  Price_and_Label --> Carousel_Product
  Button --> Carousel_Product
...
| Carousel Product | Star, Badges and Tags, Price and Label, Button |
| Free Trial Card | Button, Badges and Tags |
| Modal Dialog | Button, Close Button, Modal Button Group, Text Section |
| Multi-CTA List | CTA Row |
| Product Content | Button, Stepper Control, Star, Badges and Tags, Price and Label, Text Button—Icon Right |
| Product Grid Card | Button, Badges and Tags, Price and Label, Star |
