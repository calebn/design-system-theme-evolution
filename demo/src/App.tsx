        ...
        <Slide>
          ...
          >
            <div>
              ...
              >
                What if the design tool itself
                <br />
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <li>
                <strong>Restyle</strong> — change a value
              </li>
              <li>
                <strong>Add</strong> — introduce a new token
              </li>
              <li>
                <strong>Combine</strong> — merge, keep old names as aliases
              </li>
            </ul>
          </div>
          <div
          ...
          >
            ...
            >
              <li>
                <strong>Split</strong> — one token becomes multiple new names
              </li>
              <li>
                <strong>Delete</strong> — remove a token entirely
              </li>
            </ul>
          </div>
        </div>
