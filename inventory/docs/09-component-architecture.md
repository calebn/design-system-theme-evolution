...
| `Pagination` | `pagination/` | Selection & Controls | [Next-Previous Selector](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=1758-5088) | `<nav>` | Single numbered/dot page selector with prev/next controls; distinct from SliderProgress which is a carousel progress indicator |
| `SliderProgress` | `slider-progress/` | Selection & Controls | [Slider page selector](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=1756-2384), [Slider Scroll Bar](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=2245-93685) | `<div>` | Both are carousel/slider progress indicators; neither is page-based navigation like Pagination |
...
| [Slider page selector](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=1756-2384) | `SliderProgress` | Primitive | `slider-progress/` | `variant`, `scale` |
| [Slider Scroll Bar](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=2245-93685) | `SliderProgress` | Primitive | `slider-progress/` | `variant`, `scale` |
