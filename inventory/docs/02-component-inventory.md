...
> **71 total components** extracted from the "Molecules & Atoms" Figma page.

## Atoms (27)

| Component | Category | Variants | Property Axes | Responsive | HTML Element | Figma ID |
|-----------|----------|----------|---------------|------------|--------------|----------|
| Accordion Section | Content Layout | 12 | Size, State | ✅ | `<details>` | [1859:51731](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=1859-51731) |
| Breadcrumbs | Navigation | 4 | State | — | `<nav>` | [1623:4917](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=1623-4917) |
| Button | Actions | 216 | Type, Size, Style, Background, State | — | `<button>` | [1623:3480](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=1623-3480) |
| Button Menu | Navigation | 10 | State, Size | — | `<nav>` | [1623:5096](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=1623-5096) |
...
| Simple Menu | Navigation | 5 | State | — | `<nav>` | [1623:4958](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=1623-4958) |
...
| Tabbed Selector Button | Navigation | 10 | Size, State | — | `<select>` | [2532:76553](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=2532-76553) |
| Text Button—Icon Left | Actions | 16 | Type, Size, Background, State | — | `<button>` | [5762:102995](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=5762-102995) |
| Text Button—Icon Right | Actions | 32 | Type, Size, Background, State | — | `<button>` | [1623:4782](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=1623-4782) |

## Molecules (16)

| Component | Category | Variants | Property Axes | Responsive | HTML Element | Figma ID |
|-----------|----------|----------|---------------|------------|--------------|----------|
| Basic Form | Data Entry | 7 | Size, Background Color, State | ✅ | `<form>` | [2761:34608](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=2761-34608) |
| Button group | Selection & Controls | 6 | Size, Type | ✅ | `<button>` | [1623:5083](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=1623-5083) |
| Carousel Product | Product | 1 | Style | — | `<article>` | [2262:261677](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=2262-261677) |
| Free Trial Card | Product | 1 | Style | — | `<article>` | [1880:108955](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=1880-108955) |
| Modal Dialog | Feedback & Overlays | 6 | Size, Style, State | ✅ | `<dialog>` | [5787:116045](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=5787-116045) |
| Multi-CTA List | Product | 1 | Size | — | `<button>` | [2769:25078](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=2769-25078) |
| Product Content | Product | 3 | Style | — | `<article>` | [1949:59922](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=1949-59922) |
| Product Grid Card | Product | 3 | Size, Style | ✅ | `<article>` | [1982:24943](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=1982-24943) |
| Product Lineup—Single | Product | 3 | Size | ✅ | `<article>` | [1949:49395](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=1949-49395) |
| Section Headline | Content Layout | 3 | Size | ✅ | `<section>` | [2529:76419](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=2529-76419) |
| Section Headline with CTA | Content Layout | 4 | Size | ✅ | `<button>` | [2457:71522](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=2457-71522) |
| Slider page selector | Selection & Controls | 2 | Style, Size | — | `<select>` | [1756:2384](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=1756-2384) |
| Subnav Dropdown | Navigation | 3 | Size | ✅ | `<select>` | [6331:34404](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=6331-34404) |
| Text Section | Content Layout | 5 | Headline Size | — | `<section>` | [2529:76369](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=2529-76369) |
| Text Section with Button Group | Content Layout | 3 | Size | ✅ | `<button>` | [1770:9202](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=1770-9202) |
| Toast Bar | Feedback & Overlays | 8 | Type, Style | — | `<output>` | [1770:8729](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=1770-8729) |

## Inputs & Forms (22)

| Component | Category | Variants | Property Axes | Responsive | HTML Element | Figma ID |
|-----------|----------|----------|---------------|------------|--------------|----------|
| Checkbox | Data Entry | 2 | State | — | `<input[type=checkbox]>` | [1623:5118](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=1623-5118) |
| Dropdown | Data Entry | 7 | State | — | `<select>` | [1623:5473](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=1623-5473) |
...
| Text Input (single line) | Data Entry | 12 | Style, State | — | `<input>` | [1623:5130](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=1623-5130) |
...
| Component | Category | Variants | Property Axes | Responsive | HTML Element | Figma ID |
|-----------|----------|----------|---------------|------------|--------------|----------|
| Badges and Tags | Data Display | 12 | Style, Size | — | `<span>` | [1773:12115](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=1773-12115) |
| Image Ratios | Data Display | 8 | Aspect Ratio | — | `<img>` | [4450:79904](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=4450-79904) |
| List | Data Display | 4 | Style | — | `<ul>` | [1874:101886](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=1874-101886) |
| Price and Label | Data Display | 7 | Style | — | `<span>` | [3707:42767](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=3707-42767) |
| Product Images | Data Display | 7 | Aspect Ratio | — | `<img>` | [1946:5555](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=1946-5555) |
| Sale Percentage | Data Display | 8 | Style, Size | — | `<span>` | [5173:41321](https://www.figma.com/design/8J2B4UtoSMRvkLqBqyoZjB/Logos-Brand-Components?node-id=5173-41321) |
