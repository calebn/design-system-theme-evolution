...
| Compositions | 22 | Multi-primitive compositions |
...
| 07 | [Priority Dashboard](./07-priority-dashboard.md) | Build order scored by code component (49 rows) with full Figma-frame detail |
...
| `data/code-components.json` | 49 code components with tier, props, and Figma source mapping |
